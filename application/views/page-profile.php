	...
	<div id="wrapper">
			...
			<div class="container-fluid">
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						...
						<span class="glyphicon glypichon-home"></span>Home</a></li>
						<li class="active"><a href="<?= base_url();?>index.php/welcome/data_diri">
						<span class="glyphicon glypichon-home"></span>Data Diri</a></li>
						<li class="dropdown">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="<?=base_url()?>index.php/welcome/index" class=""><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
						...
						<li>
							...
							<div id="subPages" class="collapse in">
								<ul class="nav">
									<li><a href="<?=base_url()?>index.php/welcome/page_profile" class="active">Profile</a></li>
